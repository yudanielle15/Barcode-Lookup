...
if uploaded_file:
    try:
        ...
        if barcode_input:
            ...
            # First, highlight the current matches and full table, then clear the UI
            st.session_state.barcode_input = barcode_input  # Retain barcode input for highlighting
